...
public class StudentRegistration extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	   ...
	   int i = st.executeUpdate("insert into student (email_id, pwd ,age , phone, gender ) values ('" + email_id + "','" 

+ pwd + "','" +age + "','" + phone + "','" + gender + "')");
	   
	   ResultSet rs;
	   
	   rs = st.executeQuery("select * from student where email_id='" + email_id + "'");
	   ...
	   while(rs.next())
	   {
	    ...
	    if(i>0)
	    {
	    	...
	    	sendMail("javamailsystem1@gmail.com",email_id,"Account activation link",
	    			"Please click on the following link to activate your account  --> http://localhost/EduNext/stud_profile.jsp?key=",key);
