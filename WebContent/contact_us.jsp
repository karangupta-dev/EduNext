...
<table width="100%" border="3" cellpadding="0" align="center" cellspacing="1">
		...
		<tr>
         ...
         <tr>
          <td>Query</td><td> <TEXTAREA rows="4" cols="40" name="query" id="query" value="" wrap="hard" required="required" style="resize:none"/></TEXTAREA></td>
          </tr>
          <tr>
 ...
 <% 
   ...
   int i = st.executeUpdate("insert into contact (fname, lname, email_id, number , query ) values ('" + fname + "','" + lname + "','" + email + "','" + number + "','" + query +"')");
